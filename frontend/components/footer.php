    ...
    <div class="container footer-grid">
        <div class="footer-col footer-brand">
            ...
            <div class="social-links" style="margin-top: 20px; display: flex; gap: 15px;">
                <a href="<?php echo esc(SITE_INSTAGRAM); ?>" style="color: var(--accent); display: flex; align-items: center; text-decoration: none;" aria-label="Instagram">
                ...
                <a href="<?php echo esc(SITE_YOUTUBE); ?>" style="color: var(--accent); display: flex; align-items: center; text-decoration: none;" aria-label="YouTube">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33 2.78 2.78 0 0 0 1.94 2c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.33 29 29 0 0 0-.46-5.33z"></path><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"></polygon></svg>
                </a>
                <a href="https://wa.me/<?php echo esc(SITE_WHATSAPP); ?>" style="color: var(--accent); display: flex; align-items: center; text-decoration: none;" aria-label="WhatsApp">
        ...
        <div class="footer-col">
            ...
            <ul style="list-style: none; padding: 0;">
                <li style="display: flex; gap: 12px; margin-bottom: 12px; align-items: flex-start; color: rgba(255,255,255,0.8);">
                    <svg style="flex-shrink:0" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                    <span><?php echo esc(SITE_ADDRESS); ?></span>
                </li>
                <li style="display: flex; gap: 12px; margin-bottom: 12px; align-items: center; color: rgba(255,255,255,0.8);">
                ...
                <li style="display: flex; gap: 12px; align-items: center; color: rgba(255,255,255,0.8);">
                    <svg style="flex-shrink:0" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
